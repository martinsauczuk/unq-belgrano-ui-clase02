...
/****************** Utilidades ***********************/
/**
 * Transforma un string en camelCase en su versión de kebab-case.
 *
 * @param {string} str - El string a transformar a kebab-case
 * @returns
 */
...
const createElement = (elemType, props, ...children) => {
    ...
    // Y ahora también manejamos eventos en este escenario.
        ...
        if (props) {
            for (const attrKey of Object.keys(props)) {
                ...
                if (attrKey === 'className') {
                    ...
                    // Los eventos deben ser manejados por separado,
                    // y su nombre internamente va todo en minuscula
