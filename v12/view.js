...
const SendMessageBox = () => {
    const handleTextChanged = (ev) => {
        if (ev.keyCode === 13) {
            ...
            sendMessage();
            // Ya no se necesita el re-rendering acá,
            // pues ahora lo maneja directamente el observer.
        } else {
...
// Una parte importante de nuestro controlador es entonces registrarse en el
// observer, para activar el rendering cuando cambia la lista de mensajes.
